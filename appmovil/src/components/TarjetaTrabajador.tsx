    ...
    <div className="bg-white rounded-3xl border border-gray-100 shadow-sm overflow-hidden transition-all mb-4">
        ...
        <div className="flex items-center gap-4">
          ...
          <div className="flex flex-col text-left">
            ...
            <span className={`text-[10px] font-black uppercase tracking-widest flex items-center gap-1 mt-1 ${pedidos.length > 0 ? 'text-[#70a344]' : 'text-gray-400'}`}>
              <span className={`w-1.5 h-1.5 rounded-full ${pedidos.length > 0 ? 'bg-[#70a344]' : 'bg-gray-300'}`}></span>
      ...
      {isExpanded && (
        <div className="px-5 pb-5 pt-0 border-t border-gray-50 bg-gray-50/30">
          ...
          {pedidos.length > 0 ? (
            /* SI HAY PEDIDOS: Muestra las burbujas y detalles */
            <>
                ...
                <div className="bg-white p-4 rounded-2xl border border-gray-100 shadow-sm relative overflow-hidden animate-in fade-in slide-in-from-bottom-1 duration-200 mt-1">
                  ...
                  <div className="flex items-center justify-between mb-3 pl-2">
                    ...
                    {pedidoSeleccionado.estado === 'CONFIRMADO' ? (
                      ...
                      <span className="text-[9px] text-gray-300 font-bold">Pedido #{pedidoSeleccionado.id}</span>
                    )}
                  </div>
            ...
            /* 🔥 SI NO HAY PEDIDOS: Muestra un mensaje bonito de que está vacío */
