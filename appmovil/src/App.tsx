...
const App: React.FC = () => {
  return (
    <div className="min-h-screen bg-gray-50 overflow-hidden">
      <SignedOut>
        <div className="flex flex-col items-center justify-center min-h-screen bg-[#1b2c56] p-6 relative">
          ...
          <footer className="mt-8 text-[10px] text-white/40 uppercase tracking-widest text-center w-full">
